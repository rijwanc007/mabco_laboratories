...
@section('content')
    {!! Form::open(['class' =>'form-sample','route' => ['type.update',$edit->id],'method' => 'PATCH', 'enctype' => 'multipart/form-data']) !!}
    <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="name" name="name" value="{{$edit->name}}" placeholder="Enter Category Name" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select" id="type" name="type" required>
                            ...
                            <option value="Featured" @if($edit->type == 'Featured') selected @endif >Featured</option>
                        </select>
                    </div>
                </div>
            </div>
    ...
    <div class="row">
        <div class="col-md-3"></div>
        <div class="col-md-6">
            <button type="submit" class="btn btn-gradient-primary btn-lg btn-block"><i class="mdi mdi-file-document-box"></i> Update Category</button>
        </div>
    </div>
    {!! Form::close() !!}
@endsection
