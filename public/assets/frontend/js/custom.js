(function ($) {
	...
	var Ayurveda = {
        ...
        brand_slider: function () {
            var swiper = new Swiper('.pa-brand-area .swiper-container', {
                slidesPerView:5,
                loop:true,
                spaceBetween:0,
                speed:1500,
        ...
        tesimonial_slider: function () {
            ...
            $(".pa-tesimonial .swiper-container").hover(function() {
                (this).swiper.autoplay.stop();
            }, function() {
                (this).swiper.autoplay.start();
            });
        },
        customer_slider: function () {
            var swiper = new Swiper('.pa-customer .swiper-container', {
                slidesPerView:1,
                loop:true,
                spaceBetween:0,
                speed:5000,
